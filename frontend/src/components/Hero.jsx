...
function Hero() {
  return (
    ...
    <h1 className="text-2xl text-white md:text-5xl">  LETS CONNECT </h1>
     ...
     <a href="Piyush_rawat-resume.pdf" download >   <button className="flex items-center gap-2 h-11 md:h-[45px] w-52 md:w-60 justify-center bg-white rounded-2xl text-violet-950 hover:scale-105 transition">
